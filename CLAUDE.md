...
## Project Goal
Position RAIS as a practical, premium, commercially serious partner for handwerksbetriebe.
The website should sell clearer first contact and better inquiry capture, not abstract technology.
...
3. prefer trade-specific clarity over generic design patterns
...
- keep the direction aligned with handwerksbetriebe
...
- legacy commits or exported files when useful for stronger copy
...
If a page could fit any random consultant or agency, it is not sharp enough.
If a niche page can be reused with only noun swaps, it is not specialized enough.
