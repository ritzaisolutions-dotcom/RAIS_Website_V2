    ...
    <section class="page-frame">
        ...
        <article class="legal-copy">
            <div class="legal-note-block">
                <strong>Zusätzliche Unternehmensangabe</strong>
                <p>Kevin Ritz handelt unter Ritz AI Solutions (RAIS).</p>
...
<footer class="site-shell site-footer">
    <div>Rechtliche Pflichtangaben, klar und ohne Generator-Optik.</div>
