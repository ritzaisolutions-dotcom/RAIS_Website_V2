    ...
    <section class="page-frame">
        ...
        <article class="legal-copy">
            ...
            <section aria-labelledby="rais-custom-services">
                ...
                <p>Zur Erfüllung unserer Nachweispflicht nach Art.&nbsp;7 Abs.&nbsp;1 DSGVO speichern wir Ihre Consent-Entscheidung zusätzlich zur lokalen Speicherung in unserer Supabase-Datenbank (Tabelle für Consent-Nachweise; verarbeitet werden eine zufällig erzeugte pseudonyme Browser-ID, die getroffene Auswahl je Dienst und die aufgerufene Seite). Diese Browser-ID wird als personenbezogenes Datum behandelt und ebenfalls lokal in Ihrem Browser (localStorage) gespeichert, um Mehrfacheinträge zu vermeiden. Rechtsgrundlage ist Art.&nbsp;6 Abs.&nbsp;1 lit.&nbsp;c DSGVO i.&nbsp;V.&nbsp;m. Art.&nbsp;7 Abs.&nbsp;1 DSGVO.</p>
                ...
                <p>Die externe Buchungsseite von Cal.com wird auf dieser Website weder eingebettet noch beim Seitenaufruf geladen. Erst wenn Sie den deutlich gekennzeichneten Link zur Terminbuchung aktiv auswählen, wird Cal.com in einem neuen Tab geöffnet. Angaben aus dem Buchungsmodal werden nicht vorbefüllt oder an Cal.com übergeben.</p>
                ...
                <p>Über das Buchungsmodal auf unserer Startseite können Sie ein kostenloses Prozess-Audit (ca. 60 Minuten) anfragen. Dabei verarbeiten wir die von Ihnen eingegebenen Daten (Name, E-Mail-Adresse, optional die von Ihnen ausgewählte Herausforderung („Pain Point"), Teamgröße, optional Ihre Branche als Makler oder Hausverwaltung sowie die Quelle Ihrer Anfrage) zum Zweck der Vorbereitung und Durchführung des Audits. Die Angaben werden vor der Speicherung serverseitig auf erlaubte Werte und Längen geprüft. Zum Schutz vor Missbrauch begrenzen wir Anfragen und speichern dafür einen gehashten IP-Wert für höchstens 24 Stunden.</p>
                <p>Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO, da Sie mit der Anfrage die Durchführung vorvertraglicher Maßnahmen anstoßen. Die Lead-Daten werden in Notion gespeichert (Anbieter: Notion Labs, Inc., USA; Auftragsverarbeitung mit Standardvertragsklauseln) und zusätzlich per E-Mail an uns übermittelt. Supabase speichert für diese Anfrage nur einen gehashten IP-Wert zur Missbrauchsabwehr (höchstens 24 Stunden), keine Lead-Inhalte. Wenn Sie anschließend den externen Buchungslink auswählen, gelten für die dort selbst eingegebenen Daten zusätzlich die Datenschutzbestimmungen von Cal.com. Die Speicherung unserer Audit-Anfragen erfolgt grundsätzlich für bis zu 24 Monate, sofern keine Kundenbeziehung begründet wird oder gesetzliche Aufbewahrungspflichten entgegenstehen. Weitere Informationen zu Notion: <a href="https://www.notion.com/de/privacy" target="_blank" rel="noopener">https://www.notion.com/de/privacy</a>.</p>
